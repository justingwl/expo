import { NotificationRequestInput as NativeNotificationRequestInput, CalendarTriggerInput as NativeCalendarTriggerInput } from './NotificationScheduler.types';
...
export declare type CalendarTriggerInput = Omit<NativeCalendarTriggerInput['value'], 'type'> & {
    repeats?: boolean;
};
...
export interface NotificationRequestInput extends Omit<NativeNotificationRequestInput, 'priority'> {
    identifier?: string;
    priority?: NotificationPriority;
}
