import {
  NotificationRequestInput as NativeNotificationRequestInput,
  CalendarTriggerInput as NativeCalendarTriggerInput,
...
export type CalendarTriggerInput = Omit<NativeCalendarTriggerInput['value'], 'type'> & {
  repeats?: boolean;
};
